...
if ( !class_exists( 'WWLC_Emails' ) ) {
	...
	class WWLC_AJAX {
        ...
        */
        ...
        /**
         * Model that houses the logic of retrieving information relating to License Settings.
         *
         * @since 1.6.3
         * @access private
         * @var WWLC_WWS_License_Settings
         */
        private $wwlc_wws_license_settings;
        ...
        */
        ...
        public function __construct( $dependencies ) {
			...
			$this->wwlc_wws_license_settings = $dependencies[ 'WWLC_WWS_License_Settings' ];
		...
		public function wwlc_approve_user( $userID = null , $page = null ) {
			...
			$this->wwlc_user_account->wwlc_approve_user( array( 'userID' => $userID ) , $this->wwlc_emails );
		...
		public function wwlc_reject_user( $userID = null , $page = null ) {
			...
			$this->wwlc_user_account->wwlc_reject_user( array( 'userID' => $userID ) , $this->wwlc_emails );
		...
		public function wwlc_file_upload_handler() {
			...
			if ( ! in_array( $ext , $file_settings[ 'allowed_file_types' ] ) ||
		 		 ! in_array( $uploaded_file[ 'type' ] , get_allowed_mime_types() ) ) {
	    ...
	    public function run() {
            ...
            add_action( 'wp_ajax_wwlc_save_license_details' , array( $this->wwlc_wws_license_settings , 'wwlc_save_license_details' ) );
