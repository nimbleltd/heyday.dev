    ...
    var trimFieldValues = function( formFields ){
        ...
        validateRequiredField = function( formFields ){
            ...
            var checkpoint = true,
                ...
                recaptchaField = jQuery('textarea[name="g-recaptcha-response"]');
            ...
            for ( var i = 0 ; i < formFields.length ; i++ ) {
                ...
                } else if (formFields[i].attr( 'type' ) == 'text' && formFields[i].hasClass( 'phone' ) ) {

                    var mask = formFields[i].attr('data-mask');
