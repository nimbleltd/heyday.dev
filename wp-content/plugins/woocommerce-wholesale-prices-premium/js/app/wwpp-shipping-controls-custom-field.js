...
jQuery( document ).ready( function ( $ ) {
    ...
    $shipping_method_controls.on( "reset_fields" , function( event ) {
        ...
        $shipping_zone_methods.html( '<option value="">' + wwpp_shipping_controls_custom_field_params.i18n_wc2_6_select_shipping_method + '</option>' );
    ...
    $shipping_zones.on( "change" , function( event , selected_method_instance_id ) {
        ...
        if ( zone_id ) {
            ...
            $.ajax( {
                'url'      : ajaxurl,
                'type'     : 'POST',
                'data'     : { action : 'wwpp_get_zone_shipping_methods' , zone_id : zone_id },
                'dataType' : 'json'
            } )
            .done( function( data , text_status , jqxhr ) {
                ...
                if ( data.status == 'success' ) {
                    ...
                    var shipping_method_options = '<option value="">' + wwpp_shipping_controls_custom_field_params.i18n_wc2_6_select_shipping_method + '</option>';

                    for ( var method_instance_id in data.shipping_methods  ) {

                        if ( data.shipping_methods.hasOwnProperty( method_instance_id ) ) {

                            var selected = ( selected_method_instance_id && method_instance_id == selected_method_instance_id ) ? 'selected="selected"' : '';
                            shipping_method_options += '<option value="' + method_instance_id + '" ' + selected + '>' + data.shipping_methods[ method_instance_id ] + '</option>';
                    ...
                    console.log( data );
                    toastr.error( data.error_message , wwpp_shipping_controls_custom_field_params.i18n_wc2_6_failed_to_retrieve_shipping_zone_methods , { "closeButton" : true , "showDuration" : errorMessageDuration } );
            ...
            .fail( function( jqxhr , text_status , error_thrown ) {
                ...
                console.log( jqxhr );
                toastr.error( '' , wwpp_shipping_controls_custom_field_params.i18n_wc2_6_failed_to_retrieve_shipping_zone_methods , { "closeButton" : true , "showDuration" : errorMessageDuration } );
    ...
    $add_mapping.click( function() {
        ...
        if ( errors.length > 0 ) {
            ...
            toastr.error( err_msg , wwpp_shipping_controls_custom_field_params.i18n_wc2_6_please_fill_the_form_properly , { "closeButton" : true , "showDuration" : errorMessageDuration } );
            ...
            $.ajax( {
                'url'      : ajaxurl,
                'type'     : 'POST',
                'data'     : { action : 'wwpp_add_wholesale_zone_mapping' , mapping : mapping },
                'dataType' : 'json'
            } )
            .done( function( data , text_status , jqxhr ) {
                ...
                if ( data.status == 'success' ) {
                    ...
                    if ( $mapping_table.find( "tr.no-items" ).length > 0 )
                        $mapping_table.find( "tr.no-items" ).remove();
                    ...
                    if ( mapping[ 'use_non_zoned_shipping_method' ] == 'yes' ) {
                        ...
                        shipping_method_meta = '<span class="non-zoned-shipping-method">' + mapping[ 'non_zoned_shipping_method' ] + '</span>';

                    } else {

                        shipping_method_meta = '<span class="shipping-zone">' + mapping[ 'shipping_zone' ] + '</span>' +
                                                  '<span class="shipping-method">' + mapping[ 'shipping_method' ] + '</span>';
                    ...
                    if ( mapping[ 'use_non_zoned_shipping_method' ] == 'yes' ) {
                        ...
                        shipping_method_text = '<td class="shipping-zone-text"></td>' +
                                               '<td class="shipping-method-text">' + mapping[ 'non_zoned_shipping_method_text' ] + '</td>';

                    } else {

                        shipping_method_text = '<td class="shipping-zone-text">' + mapping[ 'shipping_zone_text' ] + '</td>' +
                                               '<td class="shipping-method-text">' + mapping[ 'shipping_method_text' ] + '</td>';

                    }

                    var tr = '<tr>' +
                                '<td class="meta hidden">' +
                                    '<span class="index">' + data.mapping_index + '</span>' +
                                    '<span class="wholesale-role">' + mapping[ 'wholesale_role' ] + '</span>' +
                                    '<span class="use-non-zoned-shipping-method">' + mapping[ 'use_non_zoned_shipping_method' ] + '</span>' +
                                    shipping_method_meta +
                                '</td>' +
                                '<td class="wholesale-role-text">' + mapping[ 'wholesale_role_text' ] + '</td>' +
                                shipping_method_text +
                                '<td class="non-zoned-method-text">' + mapping[ 'use_non_zoned_shipping_method' ] + '</td>' +
                                '<td class="controls">' +
                    ...
                    toastr.success( '' , wwpp_shipping_controls_custom_field_params.i18n_wc2_6_successfully_add_new_mapping , { "closeButton" : true , "showDuration" : successMessageDuration } );

                } else {

                    console.log( data );
                    toastr.error( data.error_message , wwpp_shipping_controls_custom_field_params.i18n_wc2_6_failed_to_add_new_mapping , { "closeButton" : true , "showDuration" : errorMessageDuration } );
            ...
            .fail( function( jqxhr , text_status , error_thrown ) {
                ...
                console.log( jqxhr );
                toastr.error( '' , wwpp_shipping_controls_custom_field_params.i18n_wc2_6_failed_to_add_new_mapping , { "closeButton" : true , "showDuration" : errorMessageDuration } );
    ...
    $cancel_edit_mapping.click( function() {
        ...
        $mapping_table
            .find( 'tr' ).removeClass( 'processing' ).end()
            .find( '.dashicons' ).css( 'visibility' , 'visible' );
    ...
    $edit_mapping.click( function() {
        ...
        if ( errors.length > 0 ) {
            ...
            $.ajax( {
                'url'      : ajaxurl,
                'type'     : 'POST',
                'data'     : { action : 'wwpp_edit_wholesale_zone_mapping' , index : index , mapping : mapping },
                'dataType' : 'json'
            } )
            .done( function( data , text_status , jqxhr ) {
                ...
                if ( data.status == 'success' ) {
                    ...
                    toastr.success( '' , wwpp_shipping_controls_custom_field_params.i18n_wc2_6_successfully_edited_mapping , { "closeButton" : true , "showDuration" : successMessageDuration } );

                } else {

                    console.log( data );
                    toastr.error( data.error_message , wwpp_shipping_controls_custom_field_params.i18n_wc2_6_failed_edited_mapping , { "closeButton" : true , "showDuration" : errorMessageDuration } );
            ...
            .fail( function( jqxhr , text_status , error_thrown ) {
                ...
                console.log( jqxhr );
                toastr.error( '' , wwpp_shipping_controls_custom_field_params.i18n_wc2_6_failed_edited_mapping , { "closeButton" : true , "showDuration" : errorMessageDuration } );
    ...
    $mapping_table.on( "click" , ".delete-mapping" , function() {
        ...
        $.ajax( {
            'url'      : ajaxurl,
            'type'     : 'POST',
            'data'     : { action : 'wwpp_delete_wholesale_zone_mapping' , index : index },
            'dataType' : 'json'
        } )
        .done( function( data , text_status , jqxhr ) {
            ...
            if ( data.status == 'success' ) {
                ...
                $mapping_table.find( 'tbody tr .meta .index:contains("' + index + '")' ).closest( 'tr' ).remove();

                if ( $mapping_table.find( 'tbody tr' ).length <= 0 )
                    $mapping_table.find( 'tbody' ).append( '<tr class="no-items">' +
                                                               '<td class="colspanchange" colspan="5">' + wwpp_shipping_controls_custom_field_params.i18n_wc2_6_no_mappings_found + '</td>' +
                                                           '</tr>' ) ;

                toastr.success( '' , wwpp_shipping_controls_custom_field_params.i18n_wc2_6_successfully_deleted_mapping , { "closeButton" : true , "showDuration" : successMessageDuration } );

            } else {

                console.log( data );
                toastr.error( data.error_message , wwpp_shipping_controls_custom_field_params.i18n_wc2_6_failed_deleted_mapping , { "closeButton" : true , "showDuration" : errorMessageDuration } );
