jQuery( document ).ready( function( $ ) {
    ...
    */
    ...
    function wrcqbwdc_construct_mapping_data( wholesale_role , start_qty , end_qty , discount , index ) {
        ...
        if ( wholesale_role == "" )
            err.push( wwpp_wrcqbwd_params.i18n_please_specify_wholesale_role );

        if ( start_qty == "" || isNaN( start_qty ) )
            err.push( wwpp_wrcqbwd_params.i18n_invalid_start_qty );

        if ( isNaN( end_qty ) )
            err.push( wwpp_wrcqbwd_params.i18n_invalid_end_qty );

        if ( discount == "" || isNaN( discount ) )
            err.push( wwpp_wrcqbwd_params.i18n_invalid_percent_discount );
    ...
    function wrcqbwdc_prepopulate_form_with_entry_data( $tr , $field_controls , $button_controls ) {
        ...
        $field_controls.find( "#wrcqbwd-wholesale-roles" ).val( $.trim( $tr.find( ".wholesale_role" ).text() ) ).trigger( "chosen:updated" );
        ...
        $field_controls.find( "#wrcqbwd-percent-discount" ).val( $.trim( $tr.find( ".percent_discount" ).text().replace( "%" , "" ) ) );
    ...
    function wrcqbwdc_form_in_processing_mode( $field_controls , $button_controls ) {
        ...
        $button_controls
            ...
            .siblings( ".spinner" ).css( "visibility" , "visible" );
    ...
    function wrcqbwdc_form_in_normal_mode( $field_controls , $button_controls ) {
        ...
        $button_controls
            ...
            .siblings( ".spinner" ).css( "visibility" , "hidden" );
        
    }

    function wrcqbwdc_add_new_mapping_table_entry( index , data , $mapping_table ) {

        var entry_str = '<tr data-index="' + index + '">' +
                            '<td class="wholesale_role">' + data.wholesale_role + '</td>' +
                            '<td class="start_qty">' + data.start_qty + '</td>' +
                            '<td class="end_qty">' + data.end_qty + '</td>' +
                            '<td class="percent_discount">' + data.percent_discount + '%</td>' +
                            '<td class="controls">' +
        ...
        if ( $mapping_table.find( "tbody tr.no-items" ).length > 0 )
            $mapping_table.find( "tbody" ).html( entry_str );
        else
            $mapping_table.find( "tbody" ).append( entry_str );
    ...
    function wrcqbwdc_edit_mapping_table_entry( index , data , $mapping_table ) {
        ...
        $mapping_table
            .find( "tbody tr[data-index='" + index + "']" )
                .find( "td.wholesale_role" ).text( data.wholesale_role ).end()
                .find( "td.start_qty" ).text( data.start_qty ).end()
                .find( "td.end_qty" ).text( data.end_qty ).end()
                .find( "td.percent_discount" ).text( data.percent_discount + "%" );
    ...
    function wrcqbwdc_remove_mapping_table_entry( index , $mapping_table ) {
        ...
        if ( $mapping_table.find( "tbody tr" ).length <= 0 )
            $mapping_table.find( "tbody" ).append( '<tr class="no-items"><td class="colspanchange" colspan="5">' + wwpp_wrcqbwd_params.i18n_no_mappings_found + '</td></tr>' );
    ...
    */
    ...
    $wrcqbwdc_add_mapping.click( function( e ) {
        ...
        var result = wrcqbwdc_construct_mapping_data( $wrcqbwdc_wholesale_roles.val() , $wrcqbwdc_starting_qty.val() , $wrcqbwdc_ending_qty.val() ,$wrcqbwdc_discount.val() );
        ...
        if ( result.status !== "success" ) {
            ...
            for ( var i = 0 ; i < result.error.length ; i++ )
                err_msg += result.error[i] + "<br/>";

            toastr.error( err_msg , wwpp_wrcqbwd_params.i18n_form_error , { "closeButton" : true , "showDuration" : error_message_duration } );   
            ...
            $.ajax( {
                url      : ajaxurl,
                type     : "post",
                data     : { action : "wwpp_add_wholesale_role_qty_based_discount_mapping" , "qty_based_discount_mapping" : result.data , user_id : wwpp_wrcqbwd_params.user_id },
                dataType : "json"
            } )
            .done( function( data ) {
                ...
                if ( data.status == "success" ) {
                    ...
                    toastr.error( data.error_msg , wwpp_wrcqbwd_params.i18n_add_mapping_error , { "closeButton" : true , "showDuration" : error_message_duration } );
                    console.log( data );
            ...
            .fail( function( jqxhr ) {
                ...
                toastr.error( wwpp_wrcqbwd_params.i18n_failed_to_record_new_mapping_entry , wwpp_wrcqbwd_params.i18n_add_mapping_error , { "closeButton" : true , "showDuration" : error_message_duration } );
                console.log( jqxhr );
    ...
    $wrcqbwdc_mapping_table.on( "click" , "tbody td.controls .delete" , function( e ) {
        ...
        if ( confirm( wwpp_wrcqbwd_params.i18n_confirm_remove_mapping ) ) {
            ...
            $.ajax( {
                url      : ajaxurl,
                type     : "post",
                data     : { action : "wwpp_delete_wholesale_role_qty_based_discount_mapping" , index : index , user_id : wwpp_wrcqbwd_params.user_id },
                dataType : "json"
            } )
            .done( function( data ) {

                if ( data.status === "success" )
                    wrcqbwdc_remove_mapping_table_entry( index , $wrcqbwdc_mapping_table );
                else {

                    toastr.error( data.error_msg , wwpp_wrcqbwd_params.i18n_delete_mapping_error , { "closeButton" : true , "showDuration" : error_message_duration } );
                    console.log( data );
            ...
            .fail( function( jqxhr ) {
                ...
                toastr.error( wwpp_wrcqbwd_params.i18n_failed_to_deleted_mapping , wwpp_wrcqbwd_params.i18n_delete_mapping_error , { "closeButton" : true , "showDuration" : error_message_duration } );
                console.log( jqxhr );
    ...
    $wrcqbwdc_cancel_save_mapping.click( function( e ) {
        ...
        $wrcqbwdc_mapping_table.find( "tbody tr" ).removeClass( "editing" ).find( "td.controls .dashicons" ).css( { "visibility" : "visible" } );
    ...
    $wrcqbwdc_save_mapping.click( function( e ) {
        ...
        var result = wrcqbwdc_construct_mapping_data( $wrcqbwdc_wholesale_roles.val() , $wrcqbwdc_starting_qty.val() , $wrcqbwdc_ending_qty.val() , $wrcqbwdc_discount.val() , $wrcqbwdc_mapping_index.val() );
        ...
        if ( result.status !== "success" ) {
            ...
            $.ajax( {
                url      : ajaxurl,
                type     : "post",
                data     : { action : "wwpp_edit_wholesale_role_qty_based_discount_mapping" , "qty_based_discount_mapping" : result.data , user_id : wwpp_wrcqbwd_params.user_id },
                dataType : "json"
            } )
            .done( function( data ) {
                ...
                if ( data.status == "success" ) {
                    ...
                    toastr.error( data.error_msg , wwpp_wrcqbwd_params.i18n_edit_mapping_error , { "closeButton" : true , "showDuration" : error_message_duration } );
                    console.log( data );
            ...
            .fail( function( jqxhr ) {
                ...
                toastr.error( wwpp_wrcqbwd_params.i18n_failed_edit_mapping , wwpp_wrcqbwd_params.i18n_edit_mapping_error , { "closeButton" : true , "showDuration" : error_message_duration } );
                console.log( jqxhr );
