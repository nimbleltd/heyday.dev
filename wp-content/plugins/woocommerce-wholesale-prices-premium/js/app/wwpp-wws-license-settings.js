        ...
        wwppBackendAjaxServices.saveWWPPLicenseDetails( $licenseDetails )
            .done( function ( data , textStatus , jqXHR ) {
                ...
                if ( data.status == "success" ) {
                    ...
                    toastr.success( '' , wwpp_wws_license_settings_params.i18n_success_save_wholesale_price , { "closeButton" : true , "showDuration" : successMessageDuration } );

                } else {

                    toastr.error( '' , wwpp_wws_license_settings_params.i18n_fail_save_wholesale_price , { "closeButton" : true , "showDuration" : errorMessageDuration } );
