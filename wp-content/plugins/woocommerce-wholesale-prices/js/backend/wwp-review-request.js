...
jQuery( document ).ready( function( $ ) {
    ...
    var ajax_args = {
        url      : ajaxurl,
        type     : "POST",
        data     : { action : "wwp_request_review_response" , review_request_response : "" },
        dataType : "json"
    };
    ...
    vex.dialog.open( {
        ...
        buttons: [
            $.extend( {} , vex.dialog.buttons.YES , { className : "vex-dialog-button-primary" , text : "Review" , click : function ( $vexContent , event ) {
            ...
            $.extend( {} , vex.dialog.buttons.NO , { className : "vex-dialog-button-review-later" , text : "Review Later" , click : function ( $vexContent , event) {
            ...
            $.extend( {} , vex.dialog.buttons.NO , { className : "vex-dialog-button-never-show" , text : "Don't show again" , click: function ( $vexContent , event) {
